...
source <(curl -fsSL https://raw.githubusercontent.com/Quentis/ProxmoxVE/main/misc/core.func)
source <(curl -fsSL https://raw.githubusercontent.com/Quentis/ProxmoxVE/main/misc/tools.func)
source <(curl -fsSL https://raw.githubusercontent.com/Quentis/ProxmoxVE/main/misc/error_handler.func)
...
type=update bash -c "$(curl -fsSL https://raw.githubusercontent.com/Quentis/ProxmoxVE/main/tools/addon/qbittorrent-exporter.sh)"
UPDATEEOF
