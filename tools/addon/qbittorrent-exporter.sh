...
source <(curl -fsSL https://raw.githubusercontent.com/Quentis/ProxmoxVE/dev/misc/core.func)
source <(curl -fsSL https://raw.githubusercontent.com/Quentis/ProxmoxVE/dev/misc/tools.func)
source <(curl -fsSL https://raw.githubusercontent.com/Quentis/ProxmoxVE/dev/misc/error_handler.func)
...
type=update bash -c "$(curl -fsSL https://raw.githubusercontent.com/Quentis/ProxmoxVE/dev/tools/addon/qbittorrent-exporter.sh)"
UPDATEEOF
