<div align="center">
  <img src="https://raw.githubusercontent.com/Quentis/ProxmoxVE/dev/misc/images/logo-81x112.png" height="120px" alt="Proxmox VE Helper-Scripts Logo" />
...
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/Quentis/ProxmoxVE/dev/ct/pve-scripts-local.sh)"
```
