...
**Simplest form:**
```bash
var_hostname=myserver bash -c "$(curl -fsSL https://raw.githubusercontent.com/Quentis/ProxmoxVE/dev/ct/debian.sh)"
```
...
var_gateway=192.168.1.1 \
  bash -c "$(curl -fsSL https://raw.githubusercontent.com/Quentis/ProxmoxVE/dev/ct/debian.sh)"
